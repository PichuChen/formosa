...
#define _ms_bbschatd_1	"歡迎光臨! 聊天室已運作了 [1;33m%d[0m 分鐘 [1;32m%d[0m 秒! 目前共有 [1;36m%d[0m 位使用者在聊天室中!\r\n"
#define _ms_bbschatd_6	"使用者 %s 離開本頻道\r\n"
#define _ms_bbschatd_7	"舊 op 已離開, 本頻道 op 現由您接手, 密碼為: %s\r\n"
#define _ms_bbschatd_8	"舊 op 已離開, 本頻道 op 現由您接手!\r\n"
#define _ms_bbschatd_9	"%s 加入囉!\r\n"
#define _ms_bbschatd_10	"/%s\t%s\t%s 悄悄對你說：%s\r\n"
#define _ms_bbschatd_11	"你悄悄對 %s 說：%s\r\n"
#define _ms_bbschatd_12	"*** 【[1;37m%s[m】更換匿稱為【[1;33m%s[m】\r\n"
#define _ms_bbschatd_13	"*** 【[1;33m%s[m】進來囉! 大家好!\r\n"
/* #define _ms_bbschatd_14      "%s 大聲說: %s\r\n" */
#define _ms_bbschatd_15	"*** 【[1;33m%s[m】回家囉! 後會有期!\r\n"
#define	_msg_chat_27	"** 更換本頻道主題為: [1;36m%s[m **\r\n"
#define	_msg_chat_30	"*** 更換本頻道密碼為: [1;36m%s[m\r\n"
#define	_msg_chat_31	"*** 更換本頻道密碼完成 **\r\n"
#define	_msg_chat_33	"*** 解除本頻道密碼完成 **\r\n"

#define _ms_bbschatd_50 "*** 無此頻道存在!!\r\n"
#define	_msg_chat_12	"*** 目前所在頻道無此使用者 或 缺少要送出之訊息 **\r\n"
#define	_msg_chat_22	"*** 錯誤: 沒有指定要加入的頻道名稱\r\n"
#define	_msg_chat_23	"*** 您已經在該頻道!\r\n"
#define	_msg_chat_25	"*** 加入 [1;36m%s[m 頻道失敗: 權限不足 **\r\n"
#define	_msg_chat_26	"*** 錯誤: 沒有指定主題\r\n"
#define	_msg_chat_28	"*** 更換本頻道主題失敗: 權限不足 **\r\n"
#define	_msg_chat_29	"*** 錯誤: 沒有指定密碼\r\n"
#define	_msg_chat_32	"*** 更換本頻道密碼失敗: 權限不足 **\r\n"
#define	_msg_chat_38	"*** 錯誤: 至少要給個名字\r\n"
#define	_msg_chat_40	"匿稱重複\r\n"
	...
	if (--(Chanrec[oldchid].members) > 0)
	{
		...
		if (!strcmp(cuser->userid, Chanrec[oldchid].op))
		{
			...
			for (i = 0; i < MAXPORTS; i++)
			{
				...
				if (i == seat)
					continue;
				if (Usrec[i].chid == oldchid)	/* 順位 op 接手 */
				{
