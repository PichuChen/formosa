...
#define	_msg_stuff_2	MsgInfo(363)	/*	"[1;37;44m       Á`±i¶K¼Æ = [33m%-45d[m   "	*/
#define	_msg_stuff_3	MsgInfo(364)	/*	"[1;37;44m       ¤W¯¸¦¸¼Æ = [33m%-45d[m   "	*/
#define	_msg_stuff_4	MsgInfo(365)	/*	"[1;37;44m   ¤W¦¸µn¤J®É¨è = [33m%-45s[m   "	*/
#define	_msg_stuff_5	MsgInfo(366)	/*	"[1;37;44m   ¤W¦¸µn¤J¦ì¸m = [33m%-45s[m   "	*/
#define	_msg_stuff_6	MsgInfo(367)	/*	"[1;37;44m   ¥»¦¸µn¤J®É¨è = [33m%-45s[m   "	*/
#define	_msg_stuff_7	MsgInfo(368)	/*	"[1;37;44m   ¥»¦¸µn¤J¦ì¸m = [33m%-45s[m   "	*/
